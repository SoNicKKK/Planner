...
print('\nСтандартные отклонения (тестовое, по ниткам, по поездам до и после допланирования: %.3f, %.3f, %.3f, %.3f' %
      (np.std(test), np.std(dep.slot), np.std(dep.trains), np.std(dep.tfill)))

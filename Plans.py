...
#   1. [Проверка длительных стоянок поездов под смену локомотивов на реальных данных](#Проверка-длительных-стоянок-поездов-под смену-локомотивов-на-реальных-данных)
#   2. [Пост-планирование и создание фейковых локомотивов](#post)
